...
--
-- Host: localhost
-- Generation Time: Feb 03, 2013 at 07:09 AM
...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `pswd` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `members` (`id`, `usr`, `pswd`, `firstname`, `lastname`, `contact_num`, `inst_id`, `email`, `hidden`, `active`, `salt`) VALUES
(1, 'admin', 'cea66c8eab50a938fbf519379153731c', 'Muhammad', 'Ali', '03001234567', 1, 'admin@host.com', 0, 1, ''),
(2, 'Adnan', '6f10dad59a79a3a0c862b8636729bb77d9caa05ac84b85a1096a2c384177fc5a', 'Adnan', 'Mansoor', '2389472398', 1, 'asdada@yahoo.com', 0, 1, 'YFXDp9TPGLFJ'),
(3, 'Murtaza', 'd391dccb2cfca6329bf11905bf6a9287228ec9792c81455d0fc01940a344187c', 'Murtaza', 'SHabbir', '28934729', 1, 'AdnanMansor@live.com', 0, 1, 'anQQo5KtBkkHB4'),
(4, 'Umer', '657256269e62b8129ca5b7c13a97eda506efa3c575bb9cd5a6fa111ebcfcf58e', 'Umer', 'Altaf', '03462807885', 1, 'umer@yahoo.com', 0, 1, 'XlZ7X3QLgt70uj');
...
--
-- Table structure for table `tlc_member`
--

CREATE TABLE IF NOT EXISTS `tlc_member` (
...
--
-- Constraints for table `tlc_member`
--
ALTER TABLE `tlc_member`
  ADD CONSTRAINT `tlc_member_ibfk_2` FOREIGN KEY (`dept_id`) REFERENCES `departments` (`id`),
  ADD CONSTRAINT `tlc_member_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`);
