...
class Events_model extends CI_Model{
	...
	function register_team($team_lead_id, $event_id, $membr_one, $membr_two, $alt_contact, $extras){
		//make this a boolean fn and return false if the team is already registered for this event
		$team = array( 'team_lead_id'	=> $team_lead_id,
						'event_id'		=> $event_id,
						'teammate_one'	=> $membr_one,
						'teammate_two'	=> $membr_two,
						'alt_contact'	=> $alt_contact,
						'extra_info'	=> $extras );
		
		$this->db->insert("event_teams", $team);
	}
}