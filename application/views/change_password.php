                                	...
                                	<div id="left-area">
										...
										<div id='profile'>
											<?php
												...
												echo "<p>Old Password: " . form_password("old_password", set_value("old_password", "")) . "</p>";
												echo "<p>New Password: " . form_password("new_password", set_value("new_password", "")) . "</p>";
												echo "<p>Confirm Password: " . form_password("new_password2", set_value("new_password2", "")) . "</p>";
