                             	...
                             	<div id="main-content" class="clearfix">
                                	<div id="left-area">
                                    	...
                                    	<div id="events_container">
                                       		<?php
                                                echo form_open("events/create/done");
                                                echo "<p>Name: " . form_input("name", set_value("username", "Event Name")) . "</p>";
                                            ?><div id="date"><?php echo "<p>" .
                                                     "Event Date: " .
                                                     "Day: " . form_input("day", set_value("day", "1")) .
                                                     "Month: " . form_input("month", set_value("month", "1")) .
                                                     "Year: " . form_input("year", set_value("year", "2012")) .
                                                     "</p>";
												?>
                                                </div>
                                           	<?php
                                                echo "<p>About: " . form_textarea("about", set_value("about", "Write event description here.")) . "</p>";
                                                echo "<p>Rules: " . form_textarea("rules", set_value("rules", "Write event rules here.")) . "</p>";
