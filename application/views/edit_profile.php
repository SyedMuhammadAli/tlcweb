								...
								<div id="content-bottom-shadow">
                             	...
                             	<div id="main-content" class="clearfix">
                                	<div id="left-area">
                                        ...
                                        <div><h1><?php if(isset($validation_errors)){ echo "You screwed up: {$validation_errors}"; } ?></h1></div>
										<div id="profile">
											<?php
                                                echo form_open("members/edit/done");
                                        
                                                echo "<p>Facebook Username: " . form_input("fb_user_name", set_value("fb_user_name", "Facebook Username")) . "</p>";
                                                echo "<p>Phone Number: " . form_input("phone_num", set_value("phone_num", "Phone Number")) . "</p>";
                                                echo "<p>Website: " . form_input("website_link", set_value("website_link", "Website")) . "</p>";
                                                
                                                echo "<p>Email: " . form_password("email_addr", set_value("email_addr", "Email")) . "</p>";
