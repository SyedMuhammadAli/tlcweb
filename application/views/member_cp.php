								...
								<div id="content-bottom-shadow">
                             	...
                             	<div id="main-content" class="clearfix">
                                	<div id="left-area">
										...
										<div id='members_cp'>
											<?php
												echo "<strong>".anchor("members/hide_profile","Hide Profile")."</strong>"."<br/><br/>";
												echo "<strong>".anchor("members/edit","Edit Profile")."</strong>"."<br/><br/>";
												echo "<strong>".anchor("members/change_password","Change Password")."</strong>"."<br/><br/>";
											?>
                                        </div><!-- end member_cp-->
                                 	</div><!-- end left area -->
                                    <div id="sidebar">
