                             	...
                             	<div id="main-content" class="clearfix">
                                	<div id="left-area">
										...
										<div id='events_container'>
											<?php foreach($events->result() as $evt): ?>
                                            
                                            <p>
                                            <?php
                                                echo "<strong>" . anchor("events/view/{$evt->id}", $evt->name) . "</strong> on ";
                                                echo date("F j, Y, g:i a", $evt->event_date) . "<br><br>";
                                                ?>
                                            </p>
