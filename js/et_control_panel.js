jQuery(document).ready(function(){
	...
	$et_sample_color.click(function(){
		...
		if ( jQuery(this).hasClass('et-texture') ) {
			var et_texture_url = et_theme_folder + '/images/body-' + et_option_value + '.png'; console.log(et_texture_url);
	...
	var et_body_bgcolor = jQuery('#content-area').css('backgroundColor'),
	...
	jQuery('#et-control-headerfont_bg').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			...
			jQuery('h2.featured-title a').css('color', '#fff !important');
			jQuery('.main-title').css('color', '#48423F !important');
